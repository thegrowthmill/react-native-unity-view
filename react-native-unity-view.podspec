...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  react-native-unity-view
                   DESC
  s.homepage     = "https://github.com/thegrowthmill/react-native-unity-view"
  s.license      = "MIT"
  # s.license    = { :type => "MIT", :file => "LICENSE" }
  s.authors      = { "Andreas Storesund Madsen" => "andreas@asmadsen.no" }
  s.platforms    = { :ios => "9.0", :tvos => "10.0" }
  s.source       = { :git => "https://github.com/thegrowthmill/react-native-unity-view.git", :tag => "#{s.version}" }
